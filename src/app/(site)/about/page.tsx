  ...
  return (
    <div className="mx-auto flex max-w-4xl flex-col gap-16 px-4 py-16 md:px-6">
      <section className="space-y-6">
        ...
        <p className="text-base leading-relaxed text-ink-indigo-950 dark:text-slate-300">
      ...
      <section className="grid gap-6 md:grid-cols-2">
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-sm text-ink-indigo-950 dark:text-slate-300">
        ...
        <div className="space-y-3">
          ...
          <p className="text-sm text-ink-indigo-950 dark:text-slate-300">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {testimonials.map((testimonial) => (
            <blockquote
              ...
              className="space-y-3 rounded-2xl border border-soft bg-surface p-6 text-sm text-ink-indigo-950 shadow-soft dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300"
            >
