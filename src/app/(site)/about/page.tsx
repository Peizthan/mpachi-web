  ...
  return (
    <div className="mx-auto flex max-w-4xl flex-col gap-16 px-4 py-16 md:px-6">
      <section className="space-y-6">
        <h1 className="text-4xl font-semibold text-slate-900 dark:text-white">Sobre María Paz</h1>
      ...
      <section className="grid gap-6 md:grid-cols-2">
        <div className="space-y-3">
          <h2 className="text-2xl font-semibold text-slate-900 dark:text-white">Credenciales y formación</h2>
        ...
        <div className="space-y-3">
          <h2 className="text-2xl font-semibold text-slate-900 dark:text-white">Filosofía de trabajo</h2>
          <p className="text-sm text-slate-700 dark:text-slate-300">
            <q className="font-medium text-slate-900 dark:text-white">
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-semibold text-slate-900 dark:text-white">Testimonios</h2>
        <div className="grid gap-4 md:grid-cols-2">
          {testimonials.map((testimonial) => (
            <blockquote
              key={testimonial.author}
              className="space-y-3 rounded-2xl border border-slate-200 bg-white p-6 text-sm text-slate-700 shadow-sm dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300"
            >
              <p className="leading-relaxed">{testimonial.quote}</p>
              <footer className="text-xs font-semibold uppercase tracking-wide text-slate-500">
                {testimonial.author}
              </footer>
            </blockquote>
          ))}
