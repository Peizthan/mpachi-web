          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="mb-16">
                ...
                <div className="font-decorative text-base leading-relaxed space-y-6 text-foreground/90">
                  <p>
              ...
              <div className="mb-16 bg-muted/30 p-8 rounded-2xl">
                ...
                <ul className="font-decorative text-base space-y-4 text-foreground/90">
        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="font-decorative text-base leading-relaxed text-foreground/90 mb-8">
              ...
              <p className="font-decorative text-base leading-relaxed text-foreground/90">
